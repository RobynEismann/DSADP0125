...
queue = []
for i in range(50):                         # anlegen der Queue mit 50 Einträgen
    queue.append(random.randint(0,1001))
...
for i in range(25):                         # Schiebergesiter nach links
...
for i in range(25):                         # Schieberegister nach rechts
